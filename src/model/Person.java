...
public class Person implements Serializable{
	  ...
	  public Person (int person_id, String shelter_name1, String shelter_name2, String person_name1,String person_name2,String person_start,String person_end,int shelter_id,String person_parent1, String person_parent2, int person_brother) {
	  ...
	  //追加
	  public Person( String shelter_name1, String shelter_name2, String person_name1,String person_name2,String person_start,String person_end,int shelter_id,String person_parent1, String person_parent2) {
		  this.shelter_name1 = shelter_name1;
		    this.shelter_name2 = shelter_name2;
		    this.person_name1= person_name1;
		    this.person_name2= person_name2;
...
//		    this.person_brother= person_brother;
	  ...
	  //更新（データの取り出し）
	  public Person(int person_id, String shelter_name1, String shelter_name2, String person_name1,String person_name2,String person_start,String person_end,int shelter_id,String person_parent1, String person_parent2) {
		    this.person_id = person_id;
		    this.shelter_name1 = shelter_name1;
		    this.shelter_name2 = shelter_name2;
		    this.person_name1= person_name1;
