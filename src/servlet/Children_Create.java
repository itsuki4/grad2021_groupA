 ...
 */
@WebServlet("/Children_Create")
public class Children_Create extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd=request.getRequestDispatcher("/WEB-INF/jsp/children_create.jsp");
...
//		String person_brother=request.getParameter("person_brother");
		...
		Person person=new Person(shelter_name1,shelter_name2,person_name1,person_name2,person_start,person_end,Integer.parseInt(shelter_id),person_parent1,person_parent2);
