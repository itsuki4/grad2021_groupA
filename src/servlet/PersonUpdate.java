...
public class PersonUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(person_id == null){
			...
			Children children=dao.findOne(Integer.parseInt(person_id));
			request.setAttribute("children", children);
			RequestDispatcher rd=request.getRequestDispatcher("/WEB-INF/jsp/childrenUpdate.jsp");
...
//		String person_brother=request.getParameter("person_brother");
		...
		Children children=new Children(Integer.parseInt(id),shelter_name1,shelter_name2,person_name1,person_name2,person_start,person_end,Integer.parseInt(shelter_id),person_parent1,person_parent2);
		ChildrenDAO dao=new ChildrenDAO();
		dao.updateOne(children);
