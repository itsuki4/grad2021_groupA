...
@WebServlet("/BrowsingEdit")
public class BrowsingEdit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/browsing_edit.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Health_dateDAO dao = new Health_dateDAO();
		List<Health_date> List = dao.HealthEdit(p_id);
