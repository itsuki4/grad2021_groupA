...
/**
 * Servlet implementation class AccountRegisterJs
 */
@WebServlet("/AccountRegisterJs")
public class AccountRegisterJs extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccountRegisterJs() {
        super();
...
//        out.println(staff_name2);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("WEB-INF/login_jsp/register_kakunin.jsp");
        rd.forward(request, response);
	}
